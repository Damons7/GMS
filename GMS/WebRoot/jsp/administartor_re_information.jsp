...
<div class="reg_div1">修 改 信 息</div>
	...
	<div class="reg_div5">
		...
		<form action="${pageContext.request.contextPath}/administartor_re1_informationServlet.do"
	...
	<%
		//获取信息集合
		EC_user re = (EC_user)request.getAttribute("rsUser1");
		if(re == null){
			out.print("没有数据 ");
	...
	%>	
		...
		<tr >	
			...
			<td class="reg_div1_infor"> <%=re.getName() %></td>
		</tr>
		<tr></tr>
		<tr >	
		...
		<tr >
			...
			<td class="reg_div1_infor"> <%=re.getSex() %></td>	
		</tr>
		<tr></tr>
	...
	%>
		<tr>
			<td><button>确定修改</button></td></form>	
		<a href="/big_job/administartor_information.do" color:"#e5e8e1";>返回</a></tr>
			</table>
