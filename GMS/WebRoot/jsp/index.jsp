...
<meta http-equiv="X-UA-Compatible" content="ie=edge"> <title>选 课 系 统</title>
        ...
        <ul class="nav nav-tabs pull-right">
            ...
            <li class="nav-item dropdown">
 			...
 			<ul class="dropdown-menu pull-right">
                        ...
                        <li class="fa fa-bell"> <a href="/big_job/re_informationServlet_test.do?idd=infor" class="dropdown-item">  个人信息 </a></li> 
            ...
            <nav class="sidebar-nav">
                <ul class="nav">
                    <li class="nav-title">系 统 菜 单 栏</li>
                        ...
                        <a href="/big_job/jsp/head.jsp" class="nav-link nav-dropdown-toggle">
                    ...
                    <li class="nav-item nav-dropdown">
                        <a href="/big_job/select_informationServlet.do" class="nav-link nav-dropdown-toggle">
                    ...
                    <li class="nav-item nav-dropdown">
                        <a href="/big_job/sc_select_informationServlet.do?school_year=1&term=1" class="nav-link nav-dropdown-toggle">
                            <i class="icon icon-target"></i> 成绩查询 <i class="fa fa-caret-left"></i>
                        </a>
                    ...
                    <li class="nav-item">
                        <a href="/big_job/courses_informationServlet.do?id=3&school_year=3&term=1" class="nav-link">
                            <i class="icon icon-puzzle"></i>课程表
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="/big_job/student_noticeServlet.do?iden=student" class="nav-link">
