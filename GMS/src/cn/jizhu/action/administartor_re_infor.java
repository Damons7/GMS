...
public class administartor_re_infor extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("rsUser1", rsUser);
		if(ad.equals("adm_infor"))
		request.getRequestDispatcher("/jsp/administartor_re_information.jsp").forward(request, response);
		else
		if(ad.equals("adm_pwd"))
	
		request.getRequestDispatcher("/jsp/administartor_re_password.jsp").forward(request, response);
